...
public class AJDBCIntroduction {
    ...
    public static void main(String[] args) throws ClassNotFoundException, SQLException {
      ...
      Connection createSQLConnection = DriverManager.getConnection(
      ...
      Statement createSQLStatementExecute = createSQLConnection.createStatement();
      ...
      //Step 4 Display the mySQL DB Result using ResultSet
        ...
        ResultSet displaySQLResultOutput = createSQLStatementExecute.executeQuery(mySqlQuery);
...
//        }
        ...
        for (int i = 1; i <= tableColumnCount; i++) {
            System.out.print(sqlTableMetaDataDetails.getColumnName(i) + "\t");
        }
        System.out.println();
